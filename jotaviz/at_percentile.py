...
def at_percentile(data_list, value, interpolation='fraction'):
    ...
    If the requested percentile falls between two values, the result can be interpolated
    ...
    h3. Example usage
        ...
        >>> import jotaviz
        >>> jotaviz.at_percentile([1, 2, 3, 4], 75)
        3.25
        >>> jotaviz.at_percentile([1, 2, 3, 4], 75, interpolation='lower')
        3.0
        >>> jotaviz.at_percentile([1, 2, 3, 4], 75, interpolation='higher')
        4.0
